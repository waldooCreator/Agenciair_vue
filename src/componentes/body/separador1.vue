            ...
            <div class="hidden md:block md:w-1/3 lg:w-1/4 mr-8">
                <div class="relative">
                    <div class="bg-white rounded-xl p-4 shadow-md transform rotate-3">
                        <div
                            class="w-full h-32 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center">
                    ...
                    <div class="absolute -top-2 -right-2 bg-white rounded-lg p-2 shadow-md transform -rotate-12">
                        <div
                            class="w-16 h-20 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-md flex items-center justify-center">
