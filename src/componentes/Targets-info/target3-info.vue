    ...
    <section class="container mx-auto px-6 md:px-10 lg:px-16 pb-24">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="section-spacing">
          ...
          <div v-for="(aliado, indiceAliado) in aliadosInternacionales" :key="indiceAliado" class="relative group mb-12">
            ...
            <div class="relative glass-effect rounded-3xl p-8 md:p-10 shadow-lg border border-white/50">
              <!-- Header con imagen -->
              <div class="mb-8">
                <!-- ÚNICO CAMBIO: responsive móvil/tablet con aspect-ratio; desktop igual -->
...
function cotizarVenezuela () {
  router.push('/cotizar-venezuela')
}

function masInformacionVenezuela () {
