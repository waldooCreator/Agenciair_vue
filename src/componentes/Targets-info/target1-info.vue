<template>
  <main class="min-h-screen bg-[rgb(241,234,218)]">
    ...
    <section class="relative overflow-hidden py-12 md:py-20">
      <!-- Desplazar contenido a la derecha como en el ejemplo -->
    ...
    <section class="pb-24">
      ...
      <!-- Contenido principal con margen a la derecha como el ejemplo -->
      <div class="lg:ml-72 lg:pl-8 md:px-10 px-6">
        <div class="container mx-auto px-0 md:px-0 lg:px-0">
          <div class="max-w-4xl mx-auto">
              ...
              <div class="relative group">
                ...
                <div class="relative glass-effect rounded-3xl p-8 md:p-12 shadow-lg border border-white/50">
                  ...
                  <div class="prose prose-lg max-w-none text-[rgb(58,26,29)] space-y-6">
                    ...
                    <p class="text-lg leading-relaxed">
                      Estas alianzas nos permiten ofrecer a nuestros clientes acceso directo a redes logísticas que abarcan más de 220 países y territorios,
                      garantizando que sus envíos lleguen a cualquier destino del mundo con la máxima seguridad y puntualidad.
                      Desde documentos urgentes hasta mercancía especializada, tenemos la solución perfecta para cada necesidad internacional.
                    </p>
            ...
            <div class="section-spacing">
              <!-- Título de categoría -->
              <div id="lideres" class="relative group mb-8 scroll-mt-28 md:scroll-mt-36">
              ...
              >
                ...
                <div class="relative glass-effect rounded-3xl p-8 md:p-10 shadow-lg border border-white/50">
                  <!-- Header con imagen -->
                  <div class="mb-8">
                    <!-- Responsive solo para móvil/tablet; desktop se mantiene -->
...
const tocItems = computed(() => {
  ...
  const contacto = { id: 'contacto', label: 'Hacer envio al extranjero', num: aliados.length + 3 }
...
const totalPaises = computed(() => 220) // Basado en la cobertura máxima de los aliados
...
/* antes
.glass-effect { background: rgba(255, 255, 255, 0.25); ... }
*/
.glass-effect {
  background: rgba(255, 255, 255, 0.98); /* casi blanco, no se tiñe con el body */
...
/* Solo móvil/tablet: logos anchos como SVG sin recorte */
@media (max-width: 1024px) {
  img[src*="logo"], img[src*="Logo"], img[src$=".svg"], img[src*="DHL_Logo"] {
