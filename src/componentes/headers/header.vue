...
<router-link to="/" class="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl md:text-2xl font-bold">
  ...
  <span class="text-white">Agencia Ir</span>
    ...
    >
      <span
        class="block w-6 h-0.5 bg-white mb-1 transition-all duration-300 transform"
        :class="{ 'rotate-45 translate-y-1.5 mb-0': mobileMenuOpen }"
      ></span>
      <span
    ...
    >
      ...
      <div class="relative">
        <button
          @click="toggleMobileDropdown('envia')"
        ...
        >
          ...
          <svg
            ...
            :class="{ 'rotate-180': mobileDropdowns.envia }"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div class="relative">
        ...
        >
          ...
          <svg
            class="w-4 h-4 transform transition-transform duration-200"
            :class="{ 'rotate-180': mobileDropdowns.servicios }"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div v-show="mobileDropdowns.servicios" class="bg-orange-50 border-l-2 border-orange-200 ml-4 mr-2 rounded">
          ...
          <button
            @click="irAServicioEmbalaje"
            class="flex items-center w-full text-left px-4 py-2.5 !text-[rgb(58,29,34)] hover:bg-orange-100 transition text-xs sm:text-[13px] font-medium leading-tight"
          >
            <svg class="w-4 h-4 mr-2 text-orange-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6"/>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12l4-4 4 2 4-2 4 4"/>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 8V6a2 2 0 012-2h4a2 2 0 012 2v2"/>
            </svg>
            Embalaje
          </button>
          <button
      ...
      <div class="relative">
        <button
          @click="toggleMobileDropdown('nosotros')"
          class="flex items-center justify-between w-full text-left text-orange-600 font-medium py-2.5 px-4 hover:bg-orange-50 transition duration-200"
        >
          <span>Nosotros</span>
          <svg
            class="w-4 h-4 transform transition-transform duration-200"
            :class="{ 'rotate-180': mobileDropdowns.nosotros }"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <div class="hidden md:flex gap-4 lg:gap-8 xl:gap-12 text-base lg:text-lg xl:text-xl font-medium relative">
      ...
      <div class="relative" @mouseenter="mostrarDropdown('servicios')" @mouseleave="ocultarDropdown('servicios')">
        ...
        <div
          v-show="dropdownsVisible.servicios"
        ...
        >
          ...
          >
            <svg class="w-5 h-5 mr-3 text-orange-500 group-hover:text-orange-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
            </svg>
            <div>
      ...
      <div class="relative" @mouseenter="mostrarDropdown('nosotros')" @mouseleave="ocultarDropdown('nosotros')">
        ...
        <div
          v-show="dropdownsVisible.nosotros"
      ...
      <!-- Acciones -->
      <router-link to="/sesion" @touchstart.native="irASesion" class="text-white font-medium border-b-2 border-transparent hover:border-white transition duration-300 py-1">
        Iniciar sesión
      </router-link>
      <router-link to="/register" @touchstart.native="irARegistro" class="text-white font-medium border-b-2 border-transparent hover:border-white transition duration-300 py-1">
        Regístrate
      </router-link>
    </div>
  </div>
