  ...
  <main class="min-h-screen bg-[rgb(241,241,240)]">
    ...
    <section class="relative overflow-hidden">
      <div class="container mx-auto px-6 md:px-10 lg:px-16 py-4 md:py-8 relative">
        ...
        <div class="text-center max-w-4xl mx-auto">
          <h1 id="titulo-principal" class="text-4xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-[rgb(248,112,62)] to-[rgb(248,112,62)] bg-clip-text text-transparent leading-tight mb-6">
            Encuéntranos
          </h1>
          
          <p class="text-lg md:text-xl text-[rgb(58,26,29)] leading-relaxed max-w-2xl mx-auto">
            Visítanos en nuestra sede principal ubicada en el centro de la ciudad.
            <span class="font-semibold text-[rgb(248,112,62)]">¡Te esperamos!</span>
          </p>
    ...
    <section class="container mx-auto px-6 md:px-10 lg:px-16 pb-24">
      <div class="max-w-6xl mx-auto">
        <!-- Mapa principal -->
        <article id="seccion-mapa" class="w-full">
          <div class="relative group">
            ...
            <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-500">
              <!-- Número de sección -->
              ...
              <div class="ml-4">
                ...
                <div class="space-y-4 text-[rgb(58,26,29)] leading-relaxed mb-6">
                  <p class="text-base md:text-lg leading-relaxed">
                    Nos encontramos estratégicamente ubicados en el centro de la ciudad para brindarte el mejor servicio de envíos y mensajería.
                  </p>
                </div>

                <!-- Contenedor del mapa responsive -->
                <div class="relative w-full h-0 pb-[50%] rounded-xl overflow-hidden shadow-lg border-2 border-[rgb(248,112,62)]/20 hover:border-[rgb(248,112,62)]/40 transition-all duration-300">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3524.984901903749!2d-72.50906121114504!3d7.8846202000000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e6645f148da440d%3A0x3cbdf3005701aa8b!2sAgencia%20IR%20-%20env%C3%ADos%20y%20mensajer%C3%ADa%20-%20Sede%20Centro!5e1!3m2!1ses-419!2sco!4v1755201533453!5m2!1ses-419!2sco&iwloc=near&disableDefaultUI=false&gestureHandling=cooperative" 
                    class="absolute top-0 left-0 w-full h-full border-0" 
                    allowfullscreen="" 
                    loading="lazy" 
                    referrerpolicy="no-referrer-when-downgrade"
                    title="Ubicación Agencia IR - Sede Centro">
                  </iframe>
                </div>
              </div>
            </div>
        ...
        <div class="relative group mt-12">
          ...
          <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
            <div class="text-center">
              <!-- Icono central -->
              <div class="w-16 h-16 bg-[rgb(248,112,62)] rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm">
              ...
              <p class="text-base md:text-lg text-[rgb(58,26,29)] mb-6 max-w-lg mx-auto">
                ¿Necesitas más información? Llámanos y te atenderemos con gusto.
              </p>
              ...
              <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                >
                  ...
                  <span class="relative z-10">+57 300 123 4567</span>
                </a>
...
// Auto-scroll cuando se monta el componente
import { onMounted } from 'vue'

onMounted(() => {
  // Primero enfoca el título por 1.5 segundos
  ...
  // Después de 1.5 segundos, hace scroll al mapa
  setTimeout(() => {
...
/* Animación suave para el hover del mapa */
.group:hover iframe {
